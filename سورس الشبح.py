...
p5 = types.InlineKeyboardButton(text = "مِــمِــوُلَ سكࢪ ",url="t.me/T_Y_L_T")
...
في قائمة المطاية اصبح مطي جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == ".":
		f2 = message.from_user.first_name
		p3 = types.InlineKeyboardMarkup()
		p5 = types.InlineKeyboardButton(text = "🇰🇼",url="t.me/T_Y_L_T")
		p3.add(p5)
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/MS_8T")
		p3.add(e4)
		h = """[مطور السورس .](t.me/MS_8T)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    ...
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/T_Y_L_T")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/MS_8T")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس الشبح
[قناة السورس .](t.me/T_Y_L_T)
[مطور السورس .](t.me/MS_8T)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "مِــمِــوُلَ سكࢪ ",url="t.me/T_Y_L_T")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @T_Y_L_T : @MS_8T*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "مِــمِــوُلَ سكࢪ ",url="t.me/T_Y_L_T")
	p3.add(p5)
